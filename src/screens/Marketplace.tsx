...
import { get_listings } from '../web3/contract-interaction';
  ...
  return (
    <View style={styles.nftContainer}>
      ...
      <TouchableOpacity style={styles.marketplaceButton} onPress={() => navigation.navigate("PayForNFT", { name: name, rarity: rarity, imageUrl: imageUrl, tokenID: tokenID, price: price })}>
        <Text style={styles.buttonText}>Buy for {Number(price)/(10**18)} TBNB</Text>
      </TouchableOpacity>
    </View>
  );
};
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <NFTComponent
            ...
            imageUrl={Number(item.id) !== 0 ? img_uri[item.id - 1] : img_uri[0]}
